...
check R-016 "Week-1 · Jira gap warning + 3 ROI metrics"              'has "Jira is <strong>not yet integrated" && has "\$ / closed-Jira" && has "\$ / merged-PR" && has "\$ / passing-test"'
...
check R-020 "Active humans 140 visible in snapshot"                  'has "140" && has "Active humans"'
...
check R-022 "Cross-reference table has Bus factor column"            'has "Bus factor" && has "Cross-reference"'
check R-023 "Repo scores"                                            'has "4.0 / 5" && has "2.0 / 5" && has "MOSTLY READY" && has "NEEDS WORK"'
check R-024 "16 Priority Actions (collapsed in §2.10)"               'has "16 priority actions"'
check R-025 "Cost optimisation \$1-2k/mo realistic"                  'has "\$1–2k"'
...
check R-029 "Champion Matrix cohorts Q1-Q4 with names"               'has "Q1 · Champions" && has "Q2 · Workflow review" && has "Q3 · Hidden potential" && has "Q4 · Mainstream"'
check R-030 "Anomalies (Amir + n8n_artem + 6 dupes)"                 'has "Amir Torabi" && has "n8n_artem" && has "6 display-name dupes"'
check R-031 "Claude Code dominance (83.4% of Anthropic)"             'has "83.4%"'
...
check R-035 "Open Harness tier for sensitive data"                   'has "Open Harness" && has "cannot leave HMND"'
...
check R-039 "Prompt-regression eval mentioned"                       'has "prompt-regression eval"'
check R-040 "Identity merge referenced (Champion Matrix Q1 note)"    'has "identity-merge"'
